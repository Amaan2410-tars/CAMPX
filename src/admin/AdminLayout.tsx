...
export default function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-[#0a0a0f] text-[#f0f0f8] overflow-hidden font-sans">
      ...
      {/* Desktop spacer so fixed sidebar never overlaps content */}
      <div className="hidden lg:block w-60 shrink-0" aria-hidden="true" />

      {/* Sidebar */}
      <aside 
        className={`fixed inset-y-0 left-0 z-50 w-60 shrink-0 transform flex flex-col bg-[#13131a] border-r border-[#1c1c27] transition-transform duration-300 ease-in-out lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}
      >
