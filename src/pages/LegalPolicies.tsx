      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <section className="bg-[#13131a] border border-[#1c1c27] rounded-3xl p-8 md:p-12" id="privacy">
          ...
          <div className="space-y-4 text-gray-400 leading-relaxed text-sm">
            ...
            <p><strong>Data Collected:</strong> We process your name, contact details, college affiliation, and interactions on the platform.</p>
        ...
        <section className="bg-[#13131a] border border-[#1c1c27] rounded-3xl p-8 md:p-12" id="refunds">
          ...
          <div className="space-y-4 text-gray-400 leading-relaxed text-sm">
            ...
            <p><strong>Refund Policy:</strong> All payments are final. We do not offer refunds under any circumstance.</p>
          </div>
        </section>

        {/* 4. Shipping Policy */}
        <section className="bg-[#13131a] border border-[#1c1c27] rounded-3xl p-8 md:p-12" id="shipping">
          <h2 className="text-2xl font-bold font-['Syne'] mb-6 text-white text-[#6c63ff]">4. Shipping Delivery Policy</h2>
          <div className="space-y-4 text-gray-400 leading-relaxed text-sm">
        ...
        <section className="bg-[#13131a] border border-[#1c1c27] rounded-3xl p-8 md:p-12" id="contact">
          <h2 className="text-2xl font-bold font-['Syne'] mb-6 text-white text-[#6c63ff]">5. Contact Us</h2>
          <div className="space-y-4 text-gray-400 leading-relaxed text-sm">
            <p>If you have any questions or require support, please contact us at:</p>
            <ul className="list-none space-y-2">
              <li><strong>Email Address:</strong> <span>{/* NEEDS FOUNDER INPUT: official support email */}support@campx.app</span></li>
              <li><strong>Contact Number:</strong> <span>{/* NEEDS FOUNDER INPUT: official support phone */}+91 XXXXX XXXXX</span></li>
              <li><strong>Operating Address:</strong> <span>{/* NEEDS FOUNDER INPUT: official company address */}CampX Technologies Pvt Ltd, India</span></li>
            </ul>
          </div>
        </section>
